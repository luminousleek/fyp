...
#
# dtls_payload_extract.tcl: Tcl script for re-creating project 'dtls_payload_extract'
#
# Generated by Vivado on Mon Dec 25 03:40:39 +0800 2023
...
#
# 1. This project restoration tcl script (dtls_payload_extract.tcl) that was generated.
#
...
#    "C:/Users/mrlee/OneDrive - National University of Singapore/NUS/FYP/dtls_payload_extract/dtls_only_top_64.v"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../dtls_payload_extract/dtls_udp_rx_64.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/dtls_only_top_64.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/eth_axis_rx.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/ip_eth_rx_64.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/udp_ip_rx_64.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/dtls_rx_top_64.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/ip_rx_top_64.v"]"\
 "[file normalize "$origin_dir/../dtls_payload_extract/eth_rx_top_64.v"]"\
  ]
  foreach ifile $files {
...
# Set board file path
set_param board.repoPaths [list "/data/isaacleexj/zybo-z7-20"]
...
set script_file "dtls_payload_extract.tcl"
...
set file "$origin_dir/../dtls_payload_extract/dtls_udp_rx_64.v"
...
set file "$origin_dir/../dtls_payload_extract/dtls_only_top_64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../dtls_payload_extract/eth_axis_rx.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../dtls_payload_extract/ip_eth_rx_64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../dtls_payload_extract/udp_ip_rx_64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../dtls_payload_extract/dtls_rx_top_64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../dtls_payload_extract/ip_rx_top_64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../dtls_payload_extract/eth_rx_top_64.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if { [get_files dtls_udp_rx_64.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/mrlee/OneDrive - National University of Singapore/NUS/FYP/dtls_payload_extract/dtls_udp_rx_64.v
}
if { [get_files dtls_only_top_64.v] == "" } {
  import_files -quiet -fileset sources_1 C:/Users/mrlee/OneDrive - National University of Singapore/NUS/FYP/dtls_payload_extract/dtls_only_top_64.v
}
...
# dtls_only_top_64
  ...
  # Create instance: dtls_only_top_64_0, and set properties
  set block_name dtls_only_top_64
  set block_cell_name dtls_only_top_64_0
  if { [catch {set dtls_only_top_64_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dtls_only_top_64_0 eq "" } {
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins dtls_only_top_64_0/s_axis]
  ...
  connect_bd_intf_net -intf_net dtls_only_top_64_0_m_axis [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins dtls_only_top_64_0/m_axis]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins dtls_only_top_64_0/rst] [get_bd_pins rst_ps7_0_50M/peripheral_reset]
